...
enum
{
	MODELMAT, VIEWMAT, TEXTURESAMPLER, OBJ2WORLD, gCOLOR, gNORMAL, gPOS, gDEPTH, gDEPTHPOS, gVIEWNORMAL, gLIGHTBUFFER, WIDTH, HEIGHT, SSAOKERNEL, SSAORADIUS, PROJMAT, NOISETEXTURE, LIGHTCOLOR, LIGHTPOS, LIGHTATT, SHR, SHG, SHB
};
